...
import com.github.tartaricacid.callresponse.mixin.accessor.LivingEntityHealthAccessorMixin;
import com.github.tartaricacid.callresponse.mixin.accessor.SynchedEntityDataAccessorMixin;
...
public final class HuntRawHealth {
    ...
    public static void write(LivingEntity target, float requestedHealth) {
        ...
        SynchedEntityData.DataItem<?> untypedItem =
                rawData.callresponse$getItemsById().get(healthAccessor.getId());
