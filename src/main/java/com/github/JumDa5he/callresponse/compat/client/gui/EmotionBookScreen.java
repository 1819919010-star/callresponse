...
import com.github.JumDa5he.callresponse.network.EmotionBookUpdateC2SPacket;
...
public class EmotionBookScreen extends Screen {
    ...
    private void onConfirm() {
        try {
            ...
            ClientPacketDistributor.sendToServer(new EmotionBookUpdateC2SPacket(maidUUID, trust, fear, hunger));
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.text(font, "信任值:", labelX, labelY + 1, 0xFFFFFF);
        graphics.text(font, "恐惧值:", labelX, labelY + 29, 0xFFFFFF);
        graphics.text(font, "饥饿值:", labelX, labelY + 57, 0xFFFFFF);
        graphics.text(font, getTitle(), centerX - font.width(getTitle()) / 2, labelY - 25, 0xFFFF55);
    }
