    ...
    protected void renderBg(GuiGraphics graphics, float partial, int mouseX, int mouseY) {
        ...
        for (int row = 0; row < 9; row++) {
            for (int col = 0; col < 12; col++) {
                graphics.renderOutline(x + 7 + col * 18, y + 17 + row * 18, 18, 18, 0xFF8B6B62);
            }
        }
        for (int row = 0; row < 3; row++) {
            for (int col = 0; col < 9; col++) {
                graphics.renderOutline(x + 34 + col * 18, y + 183 + row * 18, 18, 18, 0xFF8B6B62);
            }
        }
        for (int col = 0; col < 9; col++) {
            graphics.renderOutline(x + 34 + col * 18, y + 241, 18, 18, 0xFF8B6B62);
        }
    }
