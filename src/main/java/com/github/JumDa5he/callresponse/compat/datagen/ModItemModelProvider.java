...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        singleTexture("maid_seed", mcLoc("item/generated"), "layer0", modLoc("item/maid_seed"));
        singleTexture("dispatch_book", mcLoc("item/generated"), "layer0", modLoc("item/dispatch_book"));
        getBuilder("reward_box").parent(new ModelFile.UncheckedModelFile(modLoc("block/reward_box")));
