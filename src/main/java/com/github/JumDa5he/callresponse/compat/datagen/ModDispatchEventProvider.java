...
public final class ModDispatchEventProvider extends DispatchEventProvider {
    public ModDispatchEventProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
        super(output, CallResponseMod.MOD_ID, lookupProvider);
    }
    ...
    public void gatherDispatchEvent(Saver saver) {
        ...
        DispatchEventBuilder.builder("fishing_day")
                ...
                .enchant(Identifier.withDefaultNamespace("luck_of_the_sea"), 1, 3, 2)
                .save(saver);
        ...
        DispatchEventBuilder.builder("library_sort")
                ...
                .enchant(Identifier.withDefaultNamespace("unbreaking"), 1, 3, 3)
                .save(saver);
        ...
        DispatchEventBuilder.builder("merchant_guard")
                ...
                .enchant(Identifier.withDefaultNamespace("protection"), 2, 4, 2)
                .save(saver);
        ...
        DispatchEventBuilder.builder("village_help")
                ...
                .enchant(Identifier.withDefaultNamespace("efficiency"), 2, 4, 2)
                .save(saver);
        ...
        DispatchEventBuilder.builder("shipwreck_dive")
                ...
                .enchant(Identifier.withDefaultNamespace("respiration"), 2, 3, 2)
                .save(saver);
        ...
        DispatchEventBuilder.builder("mineshaft_inspect")
                ...
                .enchant(Identifier.withDefaultNamespace("unbreaking"), 1, 2, 3)
                .save(saver);
        ...
        DispatchEventBuilder.builder("desert_excavation")
                ...
                .enchant(Identifier.withDefaultNamespace("efficiency"), 2, 3, 2)
                .save(saver);
        ...
        DispatchEventBuilder.builder("caravan_escort")
                ...
                .enchant(Identifier.withDefaultNamespace("protection"), 3, 4, 3)
                .save(saver);
        ...
        DispatchEventBuilder.builder("fishing_contest")
                ...
                .enchant(Identifier.withDefaultNamespace("luck_of_the_sea"), 2, 3, 2)
                .save(saver);
        ...
        DispatchEventBuilder.builder("potion_order")
                ...
                .enchant(Identifier.withDefaultNamespace("unbreaking"), 1, 1, 1)
                .save(saver);
        ...
        DispatchEventBuilder.builder("cave_exploration")
                ...
                .enchant(Identifier.withDefaultNamespace("unbreaking"), 1, 2, 2)
                .save(saver);
