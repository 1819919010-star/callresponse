...
public final class ModDispatchEventProvider extends DispatchEventProvider {
    ...
    public void gatherDispatchEvent(Saver saver) {
        ...
        DispatchEventBuilder.builder("fishing_day")
                ...
                .enchant(new ResourceLocation("luck_of_the_sea"), 1, 3, 2)
                .save(saver);
        ...
        DispatchEventBuilder.builder("library_sort")
                ...
                .enchant(new ResourceLocation("unbreaking"), 1, 3, 3)
                .save(saver);
        ...
        DispatchEventBuilder.builder("merchant_guard")
                ...
                .enchant(new ResourceLocation("protection"), 2, 4, 2)
                .save(saver);
        ...
        DispatchEventBuilder.builder("village_help")
                ...
                .enchant(new ResourceLocation("efficiency"), 2, 4, 2)
                .save(saver);
        ...
        DispatchEventBuilder.builder("shipwreck_dive")
                ...
                .enchant(new ResourceLocation("respiration"), 2, 3, 2)
                .save(saver);
        ...
        DispatchEventBuilder.builder("mineshaft_inspect")
                ...
                .enchant(new ResourceLocation("unbreaking"), 1, 2, 3)
                .save(saver);
        ...
        DispatchEventBuilder.builder("desert_excavation")
                ...
                .enchant(new ResourceLocation("efficiency"), 2, 3, 2)
                .save(saver);
        ...
        DispatchEventBuilder.builder("caravan_escort")
                ...
                .enchant(new ResourceLocation("protection"), 3, 4, 3)
                .save(saver);
        ...
        DispatchEventBuilder.builder("fishing_contest")
                ...
                .enchant(new ResourceLocation("luck_of_the_sea"), 2, 3, 2)
                .save(saver);
        ...
        DispatchEventBuilder.builder("potion_order")
                ...
                .enchant(new ResourceLocation("unbreaking"), 1, 1, 1)
                .save(saver);
        ...
        DispatchEventBuilder.builder("cave_exploration")
                ...
                .enchant(new ResourceLocation("unbreaking"), 1, 2, 2)
                .save(saver);
