...
public class EmotionPassiveManager {
    ...
    private static final int WATER_INTERVAL = 1200;             // 1 分钟
                    ...
                    .forEach(maid -> {
                        ...
                        if (maid.getOwner() instanceof ServerPlayer serverOwner) {
                            ...
                            if (isLooking) {
                                ...
                                boolean isFood = mainHand.getItem().isEdible() || isFoodBlock(mainHand);
                                    ...
                                    if (timer >= FOOD_GAZE_DURATION) {
                                        ...
                                        if (lastTrigger == null || tick - lastTrigger >= GAZE_COOLDOWN) {
                                            ...
                                            if (maid.getOwner() instanceof ServerPlayer owner) {
                                                ...
                                                String prompt = "主人手上拿着食物，疑惑地看着你。" + tendencyDesc + " 根据你当前的情感状态，说一段20字左右的话表达你的反应";
